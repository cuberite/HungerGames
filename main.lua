...
function Initialize(Plugin)
	...
	PM:BindCommand("/revi",         "hungergames.Reviv",   reviveblockstwo,      " reviveblocks");
	PM:BindCommand("/canbreak",     "hungergames.Break",   CanBreak,             " CanBreak blocks");
	PM:BindCommand("/canplace",     "hungergames.Place",   CanPlace,             " CanPlace blocks");
	PM:BindCommand("/restartround", "hungergames.restart", RestartRound,         " RestartRound");
	PM:BindCommand("/startround",   "hungergames.start",   startRound,           " StartRound")
	PM:BindCommand("/players",      "ShowPlayersInGame",   ShowPlayersInGame,    " Show Players in Hunger Game");
	-- PM:BindCommand("/pl",        "ShowPlayersInGame",   pl,                   " Show Players in Hunger Game");
